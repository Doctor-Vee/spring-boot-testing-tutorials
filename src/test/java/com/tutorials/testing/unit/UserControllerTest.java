...
import com.tutorials.testing.web.controllers.UserController;
...
//        User userNew = new User(1L, "newuser1@gmail.com", "pwd", "Name");
        given(userService.createUser(any(User.class))).willAnswer(invocationOnMock -> invocationOnMock.getArgument(0));
//        given(userService.createUser(any(User.class))).willReturn(userNew);
    ...
    @Test
    void shouldReturn400WhenCreatingNewUserWithoutEmail() throws Exception {
    ...
    void shouldUpdateUser() throws Exception {
        ...
        given(userService.findUserById(userId)).willReturn(Optional.of(user));
        given(userService.updateUser(any(User.class))).willAnswer((invocationOnMock -> invocationOnMock.getArgument(0)));
